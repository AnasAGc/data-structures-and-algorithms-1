from hashmap_repeated_words import __version__
from hashmap_repeated_words.hashmap import repeated_word
...
def test_repeated_word():
    ...
    assert repeated_word('it was a wonderful morning') == None
